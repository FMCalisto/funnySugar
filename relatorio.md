...
Este projecto foi encomendado dia 30/07/2014 por Maria João Galamba (minha mãe), foi elaborado no
mesmo dia um E-Mail informativo sobre o Projecto. Quem está neste momento a trabalhar no mesmo:

- sou Eu, Francisco Maria Calisto, como Web Developer;

- a minha mãe, Maria João Galamba, fundadora do Projecto e da Marca a trabalhar como criativa no
fabrico de bolos;

- João Figueiredo, trabalha como Gestor de Conteúdo, Designer, Fotógrafo e Markteer assim como
Gestor do projecto;

Este Projecto é oferecido por mim à minha Mãe, no entanto são contabilizados custos de tempo e
de dinheiro para termos de registo.
...
Após ter o Layout, será alterado consoante a opinião e gostos do cliente.

No mesmo serão inseridos as imagens tiradas que se encontram neste momento (28/07/2014) no Facebook,
...
Neste dia desloquei-me à Biblioteca Nacional de Serpa para passar uma tarde, das 15:00 às 19:00,
a escolher quais os Layouts que melhor se enquadram no Design de um Website para Bolos Estéticos.

Foi elaborado através do E-Mail francisco.mcalisto@gmail.com com informação explicita de
alterações e de forma a melhor enquadrar a cliente, Maria Galamba, sobre um pouco de tudo
relacionado com o projecto. Este mail foi enviado para: maria_galamba@hotmail.com;
    ...
    necessárias que irei em seguida descrever e argumentar.
    ...
    Acho mesmo fundamental a alteração do nome em termos de retirar o CAPS-LOCK
    em todas as letras:
    ...
    sugerir gritantemente uma chamada de atenção, berro ou mesmo falta de educação.
    ...
    em Design, seria muito melhor tal ser feito por alguém da area.
    ...
    pois caso se aloje o site este terá direito a contas de E-Mail mais
    profissionais com o endereço do site.
    ...
    No que toca ao Alojamento Web a melhor alternativa que vejo à primeira
    vista será mesmo a Amen Portugal.
    
    
    Orçamento
    
    Duração do Registo: 1 Ano
    
    2 GB alojamento web	Incluído
    100 GB tráfego mensal	Incluído
    1 base de dados	Incluído
    Estatísticas Web AW Stats	Incluído
    Domínio grátis (no primeiro ano)	Incluído
    10 contas de e-mail POP3/IMAP4	Incluído
    
    funnysugar.com
    
    Pack Hosting Starter Linux
    
    Total: 28.10 €
    
    
    Acho o preço justo no entanto sublinho que este é um valor a ser
    pago anualmente, para que o site se mantenha online.
    
    
    
    
    Fica então aqui as minhas ideias e soluções que devem ser
    discutidas e postas em prática o mais breve possível para o sucesso
...
aspectos Técnicos dobre o projecto em si, assim como a cliente mostrou-me um projecto externo
...
Neste dia foi terminada seção de "Bolos" e "Projectos" do site da v1.0, ficando apenas por acabar a secção das "Encomendas".
